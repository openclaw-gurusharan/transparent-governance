...
4. if the fixes were merged during the same workstream, reset every touched repo to `origin/main`, delete the review branches, and clear local runtime residue before the next browser pass
